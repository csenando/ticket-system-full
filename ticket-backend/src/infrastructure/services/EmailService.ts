        ...
        try {
            ...
            <div style="font-family: Arial, sans-serif; padding: 20px; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 8px;">
                ...
                <div style="text-align: center; margin-top: 30px;">
                    <a href="https://likeness-slinky-congress.ngrok-free.dev/login" style="background-color: #3b82f6; color: white; text-decoration: none; padding: 10px 20px; border-radius: 5px; font-weight: bold;">Iniciar Sesión</a>
                </div>
